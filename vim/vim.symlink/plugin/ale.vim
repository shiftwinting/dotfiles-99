...
\ '\/components\/.*\.js$': {'ale_linters': ['standard'], 'ale_fixers': ['standard']},
\ '\/services\/.*\.js$': {'ale_linters': ['standard'], 'ale_fixers': ['standard']},
\ '\/scenes\/.*\.js$': {'ale_linters': ['standard'], 'ale_fixers': ['standard']},
\ '\/store\/.*\.js$': {'ale_linters': ['standard'], 'ale_fixers': ['standard']},
